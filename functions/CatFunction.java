...
public class CatFunction 
{
	...
	{
		Path toCatFilePath = FileSystems.getDefault().getPath(ShellFrame.currentPath.toString(), toCatFile.toString());
		if(Files.exists(toCatFilePath))
		{
			BufferedReader in = new BufferedReader(new FileReader(toCatFile));
			String fileContent = "";
